(ns lambda-lifters.lambda-liftoff.cli-log
...
(comment
  (macroexpand-1 '(log-action "foo" 1 2 3))
  (log-action "foo" 1 2 3)
  (in-section "bar" (log-action "foo" 1 2 3))
  (in-application "baz" (in-section "bar" (log-action "foo" 1 2 3))))
